...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow group">
                ...
                <div class="p-8">
                    ...
                    <p class="text-sm text-gray-500 mb-6">
                        <span class="font-semibold text-[#1a472a]">{{ $dept->ageGroups->count() }}</span> {{ __('årgange tilgængelige') }}
                    </p>
                    @endif
        ...
        <div class="text-center mt-16">
            <h2 class="text-2xl font-bold text-[#1a472a] mb-4">{{ __('Klar til at tilmelde dit barn?') }}</h2>
            <p class="text-gray-500 mb-6">{{ __('Det tager kun få minutter at tilmelde sig.') }}</p>
        ...
        <div class="mt-20 max-w-3xl mx-auto">
            <h2 class="text-2xl font-bold text-[#1a472a] mb-6 text-center">{{ __('Start din egen afdeling') }}</h2>
