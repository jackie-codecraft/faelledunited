...
class AgeGroupSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $fodboldGroups = [
            ...
            ['slug' => '2013-2020-mixed', 'label_da' => '2013–2020 Mixed',      'label_en' => '2013–2020 Mixed',    'birth_year' => 2013, 'gender' => 'mixed'],
        ];

        foreach ($fodboldGroups as $i => $g) {
            AgeGroup::create(array_merge($g, [
        ...
        // Håndbold — placeholder hold (ingen årgange endnu, men vi tilføjer ét)
        AgeGroup::create([
